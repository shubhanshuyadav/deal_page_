      ...
      <v-row>
        <v-card flat fill-height style="height:100%"  >
          ...
          <div class="description" style="height:25vh">
             <v-card-text class="d-flex text--secondary px-2 pt-1 my-0">{{ product.description.substring(0, 250) + "..." }}</v-card-text>
          </div>
        </v-card>
        <v-col>
          <v-footer bottom fixed padless class="mb-1 justify-center white">
              <v-btn
